...
import { captionElementCreator, getCaptionFromImage, matchImageCaption } from '@ckeditor/ckeditor5-image/src/imagecaption/utils';
...
export default class ImageCaptionEditing extends Plugin {
	...
	init() {
		...
		const createCaptionForEditing = captionElementCreator( view, 'Подпись' );
